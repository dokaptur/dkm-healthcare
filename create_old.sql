...
CREATE TABLE "dkm-healthcare".osoby_info ( 
	...
	CONSTRAINT fk_osoby_info_0 FOREIGN KEY ( lekarz_rodzinny ) REFERENCES "dkm-healthcare".lekarze( id_lekarz ) ON DELETE SET NULL ON UPDATE CASCADE
 );

ALTER TABLE "dkm-healthcare".osoby_info ADD CONSTRAINT ck_1 CHECK ( pesel != lekarz_rodzinny );

CREATE INDEX idx_osoby_info ON "dkm-healthcare".osoby_info ( lekarz_rodzinny );
